...
public interface SkyKojinMapper {
    //zhou 20201023
    ...
    KojinBean selectKojinStatusByStaffBg(String staffBg);
    ...
    AccountBean selectKojinFlgByBg( String staffBg);
    ...
    @Update("<script>" +
            ...
            "</script>")
    int updateStatusByBg(KojinBean record);
}
